 ...
 */
function sanitizeGeneratedHtml(value: string): string {
...
export function buildAuthoringInstructions(
  ...
  const voiceGuidance = brandVoice?.instructions?.trim()
    ...
    : "";
  return [
    "You are Storify's AI authoring assistant for merchant dashboard forms.",
...
export function buildContentResponseFormat(request: AIAuthoringRequest) {
  ...
  return {
    format: {
      ...
      description:
        "Structured draft values for Storify form fields generated by AI.",
      strict: true,
      schema: {
        type: "object",
